...
#include <stdlib.h>
#include <mmintrin.h>
#include "Groestl-mmx.h"
#include "tables.h"

/* moved here from groestl-mmx.h - SRV 08/09/2019 */
...
/* add groestl prefix to avoid name collisions - SRV 08/09/2019 */

#ifdef groestl_ORIG
int Transform512(hashState *ctx, const u8 *msg, int msglen) {
#else
int Transform512(groestl_hashState *ctx, const u8 *msg, int msglen) {
#endif /* groestl_ORIG */
  int i;
...
#else
int Transform1024(groestl_hashState *ctx, const u8 *msg, int msglen) {
#endif /* groestl_ORIG */
    
  int i;
  __m64 m64_m[COLS1024], *m64_h, m64_hm[COLS1024], tmp[COLS1024];
  u32 *msg_32;
  /* comment out unused variable - SRV 08/09/2019 */
  /* u64 *mmm = (u64*)tmp; */
...
#else
int Transform(groestl_hashState *ctx, const u8 *msg, int msglen) {
#endif /* groestl_ORIG */
...
#else
void OutputTransformation512(groestl_hashState *ctx) {
#endif /* groestl_ORIG */
  int i;
...
#else
void OutputTransformation1024(groestl_hashState *ctx) {
#endif /* groestl_ORIG */
  int i;
